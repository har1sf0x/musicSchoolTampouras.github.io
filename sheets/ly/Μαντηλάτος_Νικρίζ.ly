...
pieceName = "Μαντηλάτος Νικρίζ"
pieceSubtitle = ""
pieceFilename = "Μαντηλάτος_Νικρίζ"
source = ""
keyA = \setNikrizKey
keyB = \setNikrizBKey
...
melody = \relative c'' {
  ...
  \repeat volta 2 {
    % measure 1
    g4-0\arrowDown d'4-4\arrowDown d8-4\arrowDown cb-2\arrowUp bfb-5\arrowDown
    % measure 2
    bfb8-5\arrowDown a-0\arrowUp bfb-5\arrowDown cb-2\arrowUp bfb-5\arrowDown a-0\arrowUp g-0\arrowDown
    % measure 3
    g4-0\arrowDown cb8-2\arrowDown d8-4\arrowUp d8-4\arrowDown cb-2\arrowUp bfb-5\arrowDown
    % measure 4
    bfb8-5\arrowDown a-0\arrowUp bfb-5\arrowDown cb-2\arrowUp bfb-5\arrowDown a-0\arrowUp g-0\arrowDown
    \repeat unfold 2 {
      % measure 5-7
      \RastChord 4 \arrowDown fb8-2\arrowDown g-4\arrowUp \ADAChord 4 \arrowDown a8-0\arrowUp
      % measure 6-8
      bfb8-5\arrowDown a-0\arrowUp bfb-5\arrowDown cb-2\arrowUp bfb-5\arrowDown a-0\arrowUp g-0\arrowDown
    }
  }
  ...
  \repeat volta 2 {
    % measure 9
    g4-0\arrowDown d'8-1\arrowDown d-1\arrowUp <<g,4-0\arrowDown \single \greyNote \parenthesize d'>> d8-1\arrowUp
    % measure 10
    cb8-5\arrowDown d-1\arrowUp e-1\arrowDown fb-1\arrowUp g4-2\arrowDown fb8-1\arrowUp
    % measure 11
    g16-1\arrowDown (a-3) g16-1\arrowUp (a-3) f-1\arrowDown (g-3) e-1\arrowUp (f-2) d4-1\arrowDown cb8-2\arrowUp
    % measure 12
    d8-4\arrowDown cb-2\arrowUp bfb-5\arrowDown a-0\arrowUp \RastChord 4. \arrowDown
  }
  \section \break \sectionLabel "Γ" % \set Score.currentBarNumber = #1
  \repeat volta 2 {
    % measure 13
    \RastChord 4 \arrowDown a8-0\arrowUp bfc-5\arrowDown c4-1\arrowDown bfc8-5\arrowDown
    % measure 14
    c4-1\arrowDown cb4-2\arrowDown d4.-4\arrowDown
    % measure 15
    <<
      {g,4-0\arrowDown d'8-4\arrowDown d-4\arrowUp <<g,4-0\arrowDown \single \greyNote \parenthesize d'>> d8-4\arrowUp}
      \new Staff \with {
    ...
    % measure 17
    \grace cb8-2\arrowDown (d4-4) bfb8-5\arrowDown a-0\arrowUp \RastChord 4. \arrowDown
  }
