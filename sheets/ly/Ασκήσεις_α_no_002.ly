...
pieceName = "Ασκήσεις - no. 002"
pieceSubtitle = "α' γυμνασίου"
pieceFilename = "Ασκήσεις_α_no_002"
keyA = \setRastKey
keyB = \setRastBKey
...
melody = \new Voice \fixed c' {
  ...
  \repeat volta 2 {
    \repeat unfold 2 {d'-1\arrowDown d'-1\arrowUp}
    \repeat unfold 2 {e'-1\arrowDown e'-1\arrowUp}
  } \break
  ...
  \repeat volta 2 {
    \repeat unfold 2 {bfc-1\arrowDown bfc-1\arrowUp c'-1\arrowDown c'-1\arrowUp}
  } \break
  \section %\offset X-offset -1.8 \sectionLabel "1.3"
  \mark "2.4" \set Score.currentBarNumber = #1
  \repeat volta 2 {
    \repeat unfold 2 {c'-1\arrowDown c'-1\arrowUp d'-1\arrowDown d'-1\arrowUp}
  }
  \section %\offset X-offset -1.8 \sectionLabel "1.3"
  \mark "2.5" \set Score.currentBarNumber = #1
  \repeat volta 2 {
    \repeat unfold 2 {d'-1\arrowDown d'-1\arrowUp e'-1\arrowDown e'-1\arrowUp}
  } \break
  ...
  \repeat volta 2 {
    \repeat unfold 4 {bfc-1\arrowDown c'-1\arrowUp}
  } \break
  \section %\offset X-offset -1.8 \sectionLabel "1.3"
  \mark "3.4" \set Score.currentBarNumber = #1
  \repeat volta 2 {
    \repeat unfold 4 {c'-1\arrowDown d'-1\arrowUp}
  }
  \section %\offset X-offset -1.8 \sectionLabel "1.3"
  \mark "3.5" \set Score.currentBarNumber = #1
  \repeat volta 2 {
    \repeat unfold 4 {d'-1\arrowDown e'-1\arrowUp}
  } \break
  ...
  \repeat volta 2 {
    \repeat unfold 4 {c'-1\arrowDown bfc-1\arrowUp}
  } \break
  \section %\offset X-offset -1.8 \sectionLabel "1.3"
  \mark "4.4" \set Score.currentBarNumber = #1
  \repeat volta 2 {
    \repeat unfold 4 {d'-1\arrowDown c'-1\arrowUp}
  }
  \section %\offset X-offset -1.8 \sectionLabel "1.3"
  \mark "4.5" \set Score.currentBarNumber = #1
  \repeat volta 2 {
    \repeat unfold 4 {e'-1\arrowDown d'-1\arrowUp}
  }
}
